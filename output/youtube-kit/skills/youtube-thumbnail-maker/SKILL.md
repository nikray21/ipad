...
- **Style reference** — defaults to `/Users/fknr/Downloads/DhxDncjsItw-HD (1).jpg`. User can override by pasting a different image path.
...
7. Reference image path defaults to `/Users/fknr/Downloads/DhxDncjsItw-HD (1).jpg` but is user-overridable.
